...
const int DRIVER_STEPS = 16;          // Current driver hardware pin settings from 1 to 32. (fractions of 1/1 - 1/32)
const int DEGREES_IN_CIRCLE = 360;
const double  STEPS_PER_DEGREE = 675.555;//(DRIVER_STEPS * STEPS_PER_ROTATION * ACTUATOR_GEAR_RATIO) / DEGREES_IN_CIRCLE; //= 675.555~ 337.7775~
